...
import { AgentSession, type AgentSessionOptions } from '@bond/agent';
import { parseEvalManifest, runEvalManifest, type EvalRunReport } from '@bond/evals';
import { CORRECTNESS_CRITIC } from '@bond/judges';
import {
  AutoresearchManifestSchema,
